...
export default function UnchartedNavBarLayout() {
  ...
  return (
    <div className="w-full h-full max-w-screen-xl px-4 py-4 mx-auto text-white md:py-3 bg-[#748cab] xl:rounded-md lg:flex lg:items-center lg:justify-between lg:gap-4">
...
#b4bcd4] bg-[#748cab] text-[#748cab] hover:bg-renaissance-light/15 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-black focus:ring-blue-600"
      ...
      <div
        className={cn(
          'mt-2 lg:mt-0 rounded-lg border border-[#b4bcd4] p-4 lg:p-0 flex flex-col lg:flex-row lg:justify-between overflow-hidden transition-all duration-300 basis-full grow lg:border-transparent lg:gap-4 lg:flex',
          open ? '' : 'hidden',
        )}
      >
        <div className="flex flex-col space-y-1 md:space-y-0 md:space-x-2 font-renaissance md:flex-row md:items-center">
          ...
          <Link
            ...
            className="!mt-2 md:!mt-0 inline-flex items-center gap-2 px-4 py-1.5 uppercase transition-colors rounded-full text-[#748cab] font-renaissance bg-[#b4bcd4] w-max hover:bg-white"
          >
