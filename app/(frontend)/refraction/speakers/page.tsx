  ...
  return (
    <div className="w-full p-6 font-renaissance border-y xl:border xl:rounded-md md:p-12 border-[#1d2d44] bg-[#000000]">
      <div className="max-w-5xl mx-auto mb-10">
        <h1 className="text-3xl md:text-4xl font-bold text-[#b8c3d4] font-sans uppercase tracking-tight mb-2">
          Our Speakers
        </h1>
        <div className="h-0.5 w-24 md:w-32 bg-gradient-to-r from-[#e778b0f1] via-[#6366f1] to-[#7715fffc] rounded-full mb-6" />
        <p className="text-[#b8c3d4]/90 text-base md:text-lg font-sans leading-relaxed max-w-3xl">
      ...
      <div className="max-w-5xl mx-auto flex flex-col gap-8 md:gap-10">
        {speakers.map((speaker, i) => (
          <div
            key={i}
            className="flex gap-5 md:gap-6 p-5 md:p-6 rounded-2xl border border-[#1d2d44] bg-gradient-to-b from-[#0b1020]/60 to-[#000000]/60 font-sans"
          >
            {/* Rectangular headshot with rounded corners */}
            <div className="shrink-0">
              <div className="relative overflow-hidden rounded-lg bg-[#1d2d44] w-32 h-40 md:w-44 md:h-56">
                <Image
                  src={speaker.photo}
            ...
            {/* Name (bold), pronouns, talk title (italic), description (smaller) */}
            <div className="min-w-0">
              <p className="text-lg md:text-xl font-bold text-[#b8c3d4] leading-tight">
                {speaker.name}
                <span className="font-normal text-[#b8c3d4]/70 text-sm md:text-base ml-1.5">
                  ({speaker.pronouns})
                </span>
              </p>
              <p className="mt-1 text-base md:text-lg text-[#b8c3d4]/90 italic">
                {speaker.title}
              </p>
              <p className="mt-2 text-sm text-[#b8c3d4]/80 leading-relaxed">
                {speaker.bio}
              </p>
            </div>
          </div>
