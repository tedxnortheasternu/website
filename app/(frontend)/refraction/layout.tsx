...
import { RefractionNavBar } from '@/components/global/Refraction'
...
export const metadata: Metadata = {
    title: {
        template: `%s | TEDxNortheasternU: Refraction`,
        default: 'TEDxNortheasternU: Refraction',
    },
}
        ...
        <>
            ...
            {data ? (
                <footer className="w-full max-w-screen-xl mx-auto mt-12">
                    <h2 className="px-4 mb-6 text-2xl font-bold leading-tight text-[#b8c3d4] font-renaissance">
                        Sponsors
                    </h2>

                    <div className="grid items-center justify-center gap-2 p-4 border md:rounded-md lg:p-6 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 border-[#1d2d44]">
                        {data.length > 0 ? (
                            ...
                            <div className="col-span-3 p-4 text-center">
                                <p className="text-[#b8c3d4] font-renaissance">
